...
public class Post implements Serializable {
    /*
    All right, now you'll tackle a data type that you haven't used before. The variables postedAt and updatedAt
    are both of type Date, which allows for a bit of extra functionality. You might recognize the value of these
    variables as how you invoke the Date() method.
    To these two Date typed variables, we need to add three annotations—@NotNull, @Temporal(TemporalType.DATE),
    and @Column(name = "posted_at").
     */
    /*
    ...
    @Temporal allows us to use the type Date in the database and signals to the JPA that these fields will
    house data of that type.
